...
class JsonStorage implements StorageContract
{
    ...
    public function __construct(TeleBot $bot)
    {
        ...
        $this->path = BASE_PATH . '/storage/bot.json';
    ...
    public function __destruct()
    {
        ...
        file_put_contents($this->path, json_encode($this->data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_NUMERIC_CHECK));
    }
